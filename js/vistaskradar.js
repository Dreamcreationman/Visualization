function drawRadar(ContentId, res, stationId, date, time) {
	...
	var svg = d3.select("body")
				...
				.append("div")
				.attr("id", "radar-view");
	document.querySelector("#" +ContentId).style.width = "100%";
	document.querySelector("#" +ContentId).style.height = "100%";
	var date_time = date+" "+time;
	var myChart = echarts.init(document.getElementById("radar-view"));
	var dailyData = [];
	var dailyLevel = [];
	var monthData = [];
